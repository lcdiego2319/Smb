...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-10 col-md-offset-1 text-center" style="font-size:30px"><b>OEE</b></div>
	</div>
	<div class="row" >
		...
		<div class="col-md-10 col-md-offset-1">
			<table class="table table-striped table-bordered warning">
				<tr>
					...
					<th class="warning">Eficiencia</th>
					<th class="warning">Calidad</th> 
					<th class="warning">Disponibilidad</th>
